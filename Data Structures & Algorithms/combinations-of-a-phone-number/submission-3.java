class Solution {
    public List<String> letterCombinations(String digits) {
            ...
            backTrack(digits.toCharArray(), dials, 0, new char[digits.length()], ans);
            return ans;
        }
  

    public void backTrack(char[] digits, Map<Character, List<Character>> dials, int i, char[] sb, List<String> ans) {
        if(i >= digits.length) {
